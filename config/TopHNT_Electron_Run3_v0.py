...
fit_nominal = [
    ...
    "RooCMSShape::bkgPass(x, aCMSP[50.,40.,80.],bCMSP[0.1,0.01,0.25],cCMSP[0.05,-0.1,0.2],peakCMSP[90.0])",
    "RooCMSShape::bkgFail(x, aCMSF[50.,40.,100.],bCMSF[0.1,0.01,0.5],cCMSF[0.05,-0.1,0.2],peakCMSF[90.0])"
]
...
fit_altsig = [
    ...
    "FCONV::sigPass(x, sigPhysPass , sigResPass)",
    "FCONV::sigFail(x, sigPhysFail , sigResFail)",
    "RooCMSShape::bkgPass(x, aCMSP[50.,40.,80.],bCMSP[0.1, 0.01,0.5],cCMSP[0.05, -0.1,0.2],peakCMSP[90.0])",
    "RooCMSShape::bkgFail(x, aCMSF[50.,30.,100.],bCMSF[0.1, 0.01,0.25],cCMSF[0.05, -0.1,0.2],peakCMSF[90.0])"
]
...
#expr = ("tag_Ele_pt > 35.0 && tag_sc_abseta < 2.5"
...
#        )
expr = ("(tag_Ele_pt > 35.0 && tag_sc_abseta < 2.5 && el_q*tag_Ele_q < 0"
        "&& sqrt(2*event_met_pfmet*tag_Ele_pt*(1-cos(event_met_pfphi-tag_Ele_phi))) < 45.0"
...
expr_alttag = expr.replace("tag_Ele_pt > 35.0", "tag_Ele_pt > 37.0")
...
config = tnpConfig(
    ...
    systematic = [
        ...
        [{"title": "fitwindowup", "fit_range": (66, 120)}, {"title": "fitwindowdown", "fit_range": (57, 117)}]
    ]
)
...
Configs["TopHNT_2022_lowPT"] = config.clone(
    data = samples["data2022"],
    sim = samples["amc2022"],
    ...
    systematic = [
        ...
        [{"title": "altmc", "sim": samples["mg2022"]}],
        [{"title": "altTag", "expr": expr_alttag}],
        [{"title": "fitwindowup", "fit_range": (64, 124)}, {"title": "fitwindowdown", "fit_range": (56, 116)}]
    ],
)

Configs["TopHNT_2022_highPT"] = config.clone(
    data = samples["data2022"],
    sim = samples["amc2022"],
