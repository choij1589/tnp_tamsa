...
fit_nominal = [
    ...
    "RooCMSShape::bkgFail(x, aCMSF[50.,40.,80.],bCMSF[0.1, 0.01,0.5],cCMSF[0.05, -0.1,0.2],peakCMSF[90.0])",
]
...
fit_altsig = [
    ...
    "FCONV::sigPass(x, sigPhysPass , sigResPass)",
    "FCONV::sigFail(x, sigPhysFail , sigResFail)",
    "RooCMSShape::bkgPass(x, aCMSP[50.,40.,80.],bCMSP[0.1, 0.01,0.25],cCMSP[0.04, -0.1,0.2],peakCMSP[90.0])",
    "RooCMSShape::bkgFail(x, aCMSF[50.,30.,100.],bCMSF[0.1, 0.01,0.5],cCMSF[0.05, -0.1,0.2],peakCMSF[90.0])",
]
